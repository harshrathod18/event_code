          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link key={item.href} href={item.href}>
                <div
                  className={cn(
                    "flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-150 cursor-pointer",
                    isActive
              ...
              {roleItems.map((item) => {
                ...
                return (
                  <Link key={item.href} href={item.href}>
                    <div
                      className={cn(
                        "flex items-center px-3 py-2 text-sm rounded-md transition-colors duration-150 cursor-pointer",
                        isActive
                          ? "bg-gray-100 text-gray-900"
